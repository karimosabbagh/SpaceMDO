...
% ORBITAL ESCAPE
%----------------------------------------------------------
PB.var{1}   = {'delta_v_escape_e'     1    false     []       1    lb                20e3};
% PB.var{2}   = {'m_SC_e'             1    false    [9,18]     1    lb                ub};  
PB.var{2}   = {'r_p_e'                1    false    []         1    R_earth + 160e3   R_earth + 2000e3}; 
PB.var{3}   = {'departure_date_e'     1    false    [11,20]    1    start_date        end_date};
PB.var{4}   = {'arrival_date_e'       1    false    [12,21]    1    start_date        end_date};
...
PB.var{18}   = {'delta_v_escape_s'    3    false    []       1    lb                 20e3};
