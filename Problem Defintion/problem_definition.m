...
PB.var{2}   = {'r_p_e'                1    false    []                       1    (R_earth+160)   (R_earth+2000)}; 
...
PB.var{7}  =  {'r_p_c'                2    false    'r_p_p'                  1    (R_mars+100)    (1000+R_mars)}; 
...
PB.var{9}  =  {'V_SC_departure_c'     2    false    'V_SC_departure_e'       1    lb                80};
PB.var{10} =  {'V_SC_arrival_c'       2    true     'V_SC_arrival_e'         1    lb                80};
...
PB.var{14}   = {'delta_v_escape_s'    3    false    'delta_v_escape_e'       1    lb                80};
PB.var{15}   = {'delta_v_capture_s'   3    false    'delta_v_capture_c'      1    lb                80};
...
% PLANET COVERAGE
%----------------------------------------------------------
PB.var{18}   = {'r_p_p'               4    false    'r_p_c'                  1    (R_mars+100)   (1000+R_mars)};
