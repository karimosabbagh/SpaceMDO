...
PB.var{8}  =  {'m_prop_c'             2    false    [16]       1    lb                1000}; 
PB.var{9}  =  {'r_p_c'                2    false    [23]       1    R_mars + 100e3    170 * R_mars}; 
PB.var{10}  = {'e_c'                  2    false    [24]         1    lb                0.9};
...
% PLANET COVERAGE
%----------------------------------------------------------
PB.var{23}   = {'r_p_p'               4    false    'r_p_c'   1    R_mars             170 * R_mars  };
PB.var{24}   = {'e_p'                 4    false    'e_c'     1    lb                 0.9};
PB.var{25}   = {'T_orbit'             4    false    []        1    1e3                10e3};  
PB.var{26}   = {'eta_center'          4    false    []        1    lb                 deg2rad(45)};
PB.var{27}   = {'eta_FOV'             4    false    []        1    lb                 deg2rad(35)};
PB.var{28}   = {'IFOV'                4    false    []        1    1e-3               10};
