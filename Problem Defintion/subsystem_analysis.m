...
switch subproblem_index
    ...
    case 3
        ...
        [cost,S3_constraints] = S3_prop_struc_mass(delta_v_escape,delta_v_arrival, departure_date, arrival_date, Isp, m_structure, eta_FOV, IFOV);
        obj = cost;
     ...
     case 4
        ...
        [r_p, e, eta_center, eta_FOV_tilde, IFOV] = get_variable(x_DV, PB, 'r_p_p', 'e_p', 'T_orbit', 'eta_center', 'eta_FOV', 'IFOV');
