...
PB.var{7}  =  {'e_c'                  2    false    'e_p'                    1    0.1                0.5};
...
%----------------------------------------------------------
PB.var{10}   = {'m_prop_s'            3    false     []                       1    lb                5000}; 
PB.var{11}   = {'m_structure_s'       3    false    []                       1    lb                3000};
...
PB.var{16}   = {'IFOV_s'              3    false     'IFOV_p'                 1    1              10e4};


% PLANET COVERAGE
%----------------------------------------------------------
PB.var{17}   = {'r_p_p'               4    false    'r_p_c'                  1    (R_mars+100)/1e3   (1000+R_mars)/1e3};
PB.var{18}   = {'e_p'                 4    false    'e_c'                    1    0.1                0.5};
...
PB.var{21}   = {'IFOV_p'              4    false    'IFOV_s'                 1    1              10e4};
