...
PB.var{10}   = {'m_structure_s'       3    false    []                       1    lb                3000};
PB.var{11}   = {'Isp'                 3    false    []                       1    150               600}; 
PB.var{12}   = {'delta_v_escape_s'    3    false    'delta_v_escape_e'       1    lb                80};
PB.var{13}   = {'delta_v_capture_s'   3    false    'delta_v_capture_c'      1    lb                80};
...
PB.var{14}   = {'eta_FOV_s'           3    false    'eta_FOV_p'              1    lb                deg2rad(35)};
PB.var{15}   = {'IFOV_s'              3    false     []                 1    1              10e4};


% PLANET COVERAGE
%----------------------------------------------------------
PB.var{16}   = {'r_p_p'               4    false    'r_p_c'                  1    (R_mars+100)/1e3   (1000+R_mars)/1e3};
PB.var{17}   = {'e_p'                 4    false    'e_c'                    1    lb                0.9};
%PB.var{20}   = {'T_orbit'             4    false    []                       1    1e3               10e4};  
PB.var{18}   = {'eta_center'          4    false     []                       1    lb                deg2rad(45)};
PB.var{19}   = {'eta_FOV_p'           4    false    'eta_FOV_s'              1    deg2rad(5)                deg2rad(35)};
PB.var{20}   = {'IFOV_p'              4    false     []                 1    1              10e4};
