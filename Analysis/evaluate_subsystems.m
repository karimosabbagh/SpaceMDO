function [results, evaluations] =  evaluate_subsystems(x, PB)
    ...
    [evaluations.m_prop_s, evaluations.cost, evaluations.S3_constraints] = ...
        S3_prop_struc_mass(results.delta_v_escape_s, results.delta_v_capture_s, results.departure_date_s, results.arrival_date_s, results.Isp, results.m_structure_s, results.eta_FOV, results.IFOV);
